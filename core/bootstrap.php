...
class Bootstrap {
    ...
    private function setup(){
        // create tables
        $this->db->query("CREATE TABLE `questions` ( `id` INT NOT NULL AUTO_INCREMENT, `text` TEXT, `group` INT, `label` TEXT, `answers` TEXT, `randomize` INT, `target_responses` INT, `current_responses` INT, PRIMARY KEY (`id`) );");
